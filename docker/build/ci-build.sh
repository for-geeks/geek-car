...
bash installers/install_gflags_glog.sh
bash installers/install_protobuf.sh
bash installers/install_bazel_packages.sh
bash installers/install_google_styleguide.sh
bash installers/install_osqp.sh
