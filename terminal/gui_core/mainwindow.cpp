...
void MainWindow::on_pushButton_clicked() {
  ...
  console->sendText(QString("ssh raosiyue@") + ui->ssh_iplineEdit->text() +
                    QString("\n"));
  // sleep(1);
...
void MainWindow::on_pushButton_3_clicked() {
  ...
  connect(lateral_exercise, SIGNAL(close_sig(int)), this,
          SLOT(close_exercise(int)));
...
void MainWindow::on_pushButton_4_clicked() {
  ...
  connect(viewcalib_exercise, SIGNAL(close_sig(int)), this,
          SLOT(close_exercise(int)));
...
void MainWindow::on_pushButton_5_clicked() {
  ...
  connect(lane_exercise, SIGNAL(close_sig(int)), this,
          SLOT(close_exercise(int)));
  lane_exercise->show();
...
void MainWindow::on_pushButton_6_clicked() {
  ...
  connect(localization_exercise, SIGNAL(close_sig(int)), this,
          SLOT(close_exercise(int)));
