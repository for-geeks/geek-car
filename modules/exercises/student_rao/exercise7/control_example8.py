...
class Control(object):
	...
	self.node.create_reader("/control_reference", Control_Reference, self.speedrefcallback) 
#/planning/trajectory\
#/planning/control_trajectory
	self.node.create_reader("/perception/control_trajectory", Trajectory, self.trajectorycallback) 
	...
	self.cmd.throttle = target_speed * 30# + 6 + 8.0 * (target_speed - speed_now) + 5.0 * self.sum_error_longi
	pass
